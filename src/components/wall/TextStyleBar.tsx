...
export default function TextStyleBar({ object, onClose }: TextStyleBarProps) {
  ...
  return (
    ...
    >
      {open ? (
        <div className="pointer-events-auto max-h-[38vh] w-full max-w-lg space-y-2 overflow-y-auto rounded-2xl bg-surface p-3 text-foreground shadow-lg ring-1 ring-foreground/10 backdrop-blur-sm">
