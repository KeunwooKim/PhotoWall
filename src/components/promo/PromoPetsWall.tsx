...
interface PromoPetsWallProps {
  className?: string;
}

/** Cork wall for pet concept — same layout as friends/couple walls. */
export default function PromoPetsWall({ className = "" }: PromoPetsWallProps) {
  return (
    <div
      ...
      role="img"
      aria-label="반려동물 인생네컷과 스냅이 붙은 포토월"
    >
