...
| **QR import 모니터링** | rate limit 초과·파서 실패 로그 집계 | ⬜ *(보류)* |
...
| **P3** | Admin 2단계 (공지·기능 플래그) | ✅ |
| **P3** | Admin 2단계 (QR import 로그) | ⬜ *(보류)* |
| **P3** | 3단계 수익화 | ⬜ |
...
- [ ] 2-browser 실시간 QA 체크리스트 통과 (아래 §8.1)
